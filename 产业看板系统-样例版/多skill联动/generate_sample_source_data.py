...
SRC_FILES = [
    (Path(r"C:\Users\11\Documents\多skill联动\data_input\碳酸锂数据库.xlsx"), "碳酸锂数据库.xlsx"),
    (Path(r"C:\Users\11\Documents\market-ai-dashboard\锡数据库.xlsx"), "锡产业链数据.xlsx"),
    (Path(r"C:\Users\11\Documents\多skill联动\data_input\硅产业链数据.xlsx"), "硅产业链数据.xlsx"),
]
