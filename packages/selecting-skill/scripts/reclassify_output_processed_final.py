...
DEFAULT_DB_PATH = Path(r"<local-documents>\Selecting skill\data\output_processed_final.db")
...
if __name__ == "__main__":
    ...
    paths = [Path(arg) for arg in args.excel] if args.excel else [
        ...
        Path(r"<local-documents>\market-ai-dashboard\output_processed_final_v2.xlsx"),
    ]
    for path in paths:
