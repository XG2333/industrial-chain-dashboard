...
- `<local-documents>/market-ai-dashboard`
- `<local-documents>/Selecting skill`
- `<local-documents>/多skill联动/skills/stock-target-curator`
- `<local-documents>/多skill联动/skills/dashboard-data-sorter`
...
```powershell
& "<local-documents>\Selecting skill\.venv\Scripts\python.exe" -m workflow `
