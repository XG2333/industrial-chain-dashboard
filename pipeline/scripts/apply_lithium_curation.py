...
SRC = Path(r"<local-documents>\多skill联动\workflow_runs\20260811T084756Z_ff8cb7541bcc\02_financial_variable_curation\directory_marked.xlsx")
OUT = Path(r"<local-documents>\多skill联动\output\碳酸锂数据库_workflow.xlsx")
REPORT = Path(r"<local-documents>\多skill联动\output\碳酸锂数据库标签审计报告.md")
